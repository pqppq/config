...
export PATH=$USER_BIN:$GOPATH:$GOBIN:$GRADLE_HOME/bin:$GRADLE_USER_HOME:$MAVEN_HOME:/root/.local/bin:$DISPLAY:$LIBGL_ALWAYS_INDIRECT:$CLANG9:$LD_LIBRARY_PATH:"$DENO_INSTALL/bin:$PATH"
# eval "$(pyenv init -)"
